...
export const GlassEffect: React.FC<GlassEffectProps> = ({
  ...
  const content = (
    <div
      className={`${isPositioned ? "" : "relative"} overflow-hidden transition-all duration-700 ${className}`}
      style={glassStyle}
    >
      {/* Glass Layers */}
      <div
      ...
      <div
        ...
        style={{ background: "var(--color-glass-liquid, rgba(255, 255, 255, 0.25))" }}
      />
      <div
        className="absolute inset-0 z-20 rounded-inherit rounded-3xl overflow-hidden"
        style={{
          boxShadow:
            "inset 2px 2px 1px 0 var(--color-glass-liquid-border, rgba(255, 255, 255, 0.5)), inset -1px -1px 1px 1px var(--color-glass-liquid-border, rgba(255, 255, 255, 0.5))",
        }}
      />
...
export const GlassDock: React.FC<{ icons: DockIcon[]; href?: string }> = ({
  ...
  <GlassEffect
    href={href}
    className="rounded-3xl p-3 hover:p-4 hover:rounded-4xl flex font-semibold cursor-pointer"
  >
...
export const GlassButton: React.FC<{ children: React.ReactNode; href?: string }> = ({
  ...
  <GlassEffect
    href={href}
    className="rounded-3xl px-10 py-6 hover:px-11 hover:py-7 hover:rounded-4xl overflow-hidden flex font-semibold cursor-pointer"
  >
    <div
